    ...
    LazyColumn(
        ...
        item {
            Column(Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp)); Text(info.aboutText, style = MaterialTheme.typography.bodyMedium)
            }
        }
        if (events.isNotEmpty()) {
            item {
                Text("Upcoming Events", style = MaterialTheme.typography.titleLarge, fontWeight = FontWeight.Bold, modifier = Modifier.padding(16.dp))
            }
